...
func getDirSize(path string, includeLogSize bool, fs vfs.FS) (int64, error) {
	var size int64
...
func getNewTestDB(dir string, lldir string, fs vfs.FS) raftio.ILogDB {
...
func runLogDBTestAs(t *testing.T,
	tf func(t *testing.T, db raftio.ILogDB), fs vfs.FS) {
...
func runLogDBTest(t *testing.T, tf func(t *testing.T, db raftio.ILogDB), fs vfs.FS) {
